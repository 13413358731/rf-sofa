...
public class CgPurchasePlanDto extends BaseDto {
    public CgPurchasePlanDto(Integer id) {
        this.id = id;
    }
    ...
    public AnnualPlanDto getAnnualPlan() {
        return annualPlan;
    }

    public void setAnnualPlan(AnnualPlanDto annualPlan) {
