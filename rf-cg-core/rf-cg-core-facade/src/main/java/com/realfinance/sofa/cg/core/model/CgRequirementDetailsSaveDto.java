...
public class CgRequirementDetailsSaveDto {
    ...
    private List<CgRequirementItemSaveDto> requirementItems;

    private List<CgRequirementSupDto> requirementSups;

    private List<CgAttSaveDto> requirementAtts;

    private List<CgRequirementOaDatumDto> requirementOaData;

    private List<CgRequirementRelationshipDto> requirementRelationshipDtos;
    ...
    public List<CgRequirementItemSaveDto> getRequirementItems() {
        return requirementItems;
    }

    public void setRequirementItems(List<CgRequirementItemSaveDto> requirementItems) {
    ...
    public List<CgAttSaveDto> getRequirementAtts() {
        return requirementAtts;
    }

    public void setRequirementAtts(List<CgAttSaveDto> requirementAtts) {
    ...
    public List<CgRequirementRelationshipDto> getRequirementRelationshipDtos() {
        return requirementRelationshipDtos;
    }

    public void setRequirementRelationshipDtos(List<CgRequirementRelationshipDto> requirementRelationshipDtos) {
        this.requirementRelationshipDtos = requirementRelationshipDtos;
    }
