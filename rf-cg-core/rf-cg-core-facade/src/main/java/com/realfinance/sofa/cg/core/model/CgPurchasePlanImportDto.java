 ...
 * 导入采购计划dto
 */
public class CgPurchasePlanImportDto {
    ...
    public String toString() {
        return "CgPurchasePlanImportDto{" +
                "id=" + id +
                ", number='" + number + '\'' +
                ...
                ", plannedProcurementPeriod='" + plannedProcurementPeriod + '\'' +
                ...
                ", ImplementationDate=" + ImplementationDate +
                ", coOrdinationDepartment='" + coOrdinationDepartment + '\'' +
                ", coOrdinationDepartmentContacts='" + coOrdinationDepartmentContacts + '\'' +
                ", demandDepartment='" + demandDepartment + '\'' +
                ", demandDepartmentContacts='" + demandDepartmentContacts + '\'' +
