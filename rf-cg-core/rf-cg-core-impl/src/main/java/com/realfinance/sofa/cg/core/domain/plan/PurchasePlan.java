...
@Entity
@Table(name = "CG_CORE_PURCHASE_PLAN", indexes = {
        @Index(columnList = "number,annualPlan_id,tenantId", unique = true),
})
public class PurchasePlan extends BaseEntity implements IEntity<Integer> {
