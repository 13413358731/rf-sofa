...
// TODO: 2020/11/23 这是实现com.realfinance.sofa.flow.flowable.behavior.CustomParallelMultiInstanceBehavior时顺带写的 未经过测试 可能会出现BUG
public class CustomSequentialMultiInstanceBehavior extends SequentialMultiInstanceBehavior {

    public static final Logger log = LoggerFactory.getLogger(CustomSequentialMultiInstanceBehavior.class);
