...
public class CustomProcessDiagramGeneratorImpl extends DefaultProcessDiagramGenerator implements CustomProcessDiagramGenerator {
    ...
    protected DefaultProcessDiagramCanvas generateProcessDiagram(BpmnModel bpmnModel, String imageType,
                                                                 List<String> highLightedActivities, List<String> highLightedFlows, List<String> redHighLightedActivities,
        ...
        for (Process process : bpmnModel.getProcesses()) {
            for (FlowNode flowNode : process.findFlowElementsOfType(FlowNode.class)) {
                if (!isPartOfCollapsedSubProcess(flowNode, bpmnModel)) {
                    drawActivity(processDiagramCanvas, bpmnModel, flowNode, highLightedActivities, highLightedFlows, redHighLightedActivities, scaleFactor,drawSequenceFlowNameWithNoLabelDI);
                }
            }
        }
    ...
    protected void drawActivity(CustomProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel,
                                FlowNode flowNode, List<String> highLightedActivities, List<String> highLightedFlows, List<String> redHighLightedActivities, double scaleFactor,Boolean drawSequenceFlowNameWithNoLabelDI ) {
        ...
        if (drawInstruction != null) {
            ...
            if (highLightedActivities.contains(flowNode.getId())) {
                if (redHighLightedActivities.contains(flowNode.getId())) {
                    drawRedHighLight(processDiagramCanvas, bpmnModel.getGraphicInfo(flowNode.getId()));
                } else {
    ...
    private void drawRedHighLight(CustomProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo) {
    ...
    @Override
    public InputStream generateDiagram(BpmnModel bpmnModel, String imageType, List<String> highLightedActivities, List<String> highLightedFlows, List<String> redHighLightedActivities, String activityFontName, String labelFontName, String annotationFontName, ClassLoader customClassLoader, double scaleFactor, boolean drawSequenceFlowNameWithNoLabelDI) {
        return generateProcessDiagram(bpmnModel, imageType, highLightedActivities, highLightedFlows,redHighLightedActivities,
