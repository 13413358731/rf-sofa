...
public class ModelerDatabaseConfiguration {
    ...
    public SqlSessionFactory modelerSqlSessionFactory(DataSource dataSource) {
        ...
        try {
            ...
            properties.put("prefix", ""); // modelerAppProperties
            properties.put("blobType", "BLOB");
            properties.put("boolValue", "TRUE");
            ClassPathResource classPathResource = new ClassPathResource("/flowable/db/properties/" + databaseType + ".properties");
    ...
    // TODO: 2021/3/4 该Bean是参考FlowableApp的配置，在使用OceanBase时启动不了，暂时先注释了，不清楚有什么影响
    //@Bean
    @Qualifier("flowableModeler")
