...
public class CgProjectEvalRuleVo {
    ...
    private List<CgProjectEvalVo> projectEvals;

    public List<CgProjectEvalVo> getProjectEvals() {
        return projectEvals;
    }

    public void setProjectEvals(List<CgProjectEvalVo> projectEvals) {
