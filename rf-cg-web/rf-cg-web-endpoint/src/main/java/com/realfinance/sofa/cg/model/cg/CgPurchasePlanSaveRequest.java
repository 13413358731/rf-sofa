...
@Schema(description = "保存采购计划对象")
public class CgPurchasePlanSaveRequest {
    ...
    private ReferenceObject<Integer> annualPlan;
    ...
    public ReferenceObject<Integer> getAnnualPlan() {
        return annualPlan;
    }

    public void setAnnualPlan(ReferenceObject<Integer> annualPlan) {
