...
public class CgSupplierVo extends BaseVo implements IdentityObject<Integer> {
    ...
    protected List<CgSupplierContactsVo> contacts;

    @Schema(description = "附件")
    protected List<CgSupplierAttachmentVo> attachments;

    @Schema(description = "标签")
    protected List<CgSupplierLabelVo> supplierLabels;

    @Schema(description = "信用信息")
    protected List<CgSupplierCreditVo> credits;

    @Schema(description = "信用信息")
    protected List<CgQualityAuthVo> qualityAuths;
    ...
    public List<CgSupplierContactsVo> getContacts() {
        return contacts;
    }

    public void setContacts(List<CgSupplierContactsVo> contacts) {
        this.contacts = contacts;
    }

    public List<CgSupplierAttachmentVo> getAttachments() {
        return attachments;
    }

    public void setAttachments(List<CgSupplierAttachmentVo> attachments) {
        this.attachments = attachments;
    }

    public List<CgSupplierLabelVo> getSupplierLabels() {
        return supplierLabels;
    }

    public void setSupplierLabels(List<CgSupplierLabelVo> supplierLabels) {
        this.supplierLabels = supplierLabels;
    }

    public List<CgSupplierCreditVo> getCredits() {
        return credits;
    }

    public void setCredits(List<CgSupplierCreditVo> credits) {
        this.credits = credits;
    }

    public List<CgQualityAuthVo> getQualityAuths() {
        return qualityAuths;
    }

    public void setQualityAuths(List<CgQualityAuthVo> qualityAuths) {
